...
export declare const SWITCHBOARD_APTOS_MAINNET_CONFIG: IChainNetworkConfig;
export declare const SWITCHBOARD_APTOS_TESTNET_CONFIG: IChainNetworkConfig;
/**
...
```
 */
export declare const SWITCHBOARD_APTOS_CONFIG: IChainConfig;
