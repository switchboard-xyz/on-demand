...
export declare const SWITCHBOARD_AURORA_MAINNET_CONFIG: IEvmNetworkConfig;
export declare const SWITCHBOARD_AURORA_TESTNET_CONFIG: IEvmNetworkConfig;
/**
...
```
 */
export declare const SWITCHBOARD_AURORA_CONFIG: IChainConfig;
