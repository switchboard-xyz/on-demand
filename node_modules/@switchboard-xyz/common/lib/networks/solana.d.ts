...
export declare const SWITCHBOARD_SOLANA_MAINNET_CONFIG: ISolanaNetworkConfig;
export declare const SWITCHBOARD_SOLANA_DEVNET_CONFIG: ISolanaNetworkConfig;
/**
...
```
 */
export declare const SWITCHBOARD_SOLANA_CONFIG: ISolanaConfig;
