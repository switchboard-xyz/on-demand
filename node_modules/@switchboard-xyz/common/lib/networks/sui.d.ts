import type { IChainConfig, IMoveNetworkConfig } from "./types.js";
export declare const SWITCHBOARD_SUI_MAINNET_CONFIG: IMoveNetworkConfig;
export declare const SWITCHBOARD_SUI_TESTNET_CONFIG: IMoveNetworkConfig;
/**
...
```
 */
export declare const SWITCHBOARD_SUI_CONFIG: IChainConfig;
