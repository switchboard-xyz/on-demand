...
export declare const SWITCHBOARD_NEAR_MAINNET_CONFIG: IChainNetworkConfig;
export declare const SWITCHBOARD_NEAR_TESTNET_CONFIG: IChainNetworkConfig;
/**
...
```
 */
export declare const SWITCHBOARD_NEAR_CONFIG: IChainConfig;
