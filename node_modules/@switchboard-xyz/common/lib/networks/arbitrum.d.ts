...
export declare const SWITCHBOARD_ARBITRUM_MAINNET_CONFIG: IEvmNetworkConfig;
export declare const SWITCHBOARD_ARBITRUM_TESTNET_CONFIG: IEvmNetworkConfig;
export declare const SWITCHBOARD_ARBITRUM_SEPOLIA_CONFIG: IEvmNetworkConfig;
/**
...
```
 */
export declare const SWITCHBOARD_ARBITRUM_CONFIG: IChainConfig;
