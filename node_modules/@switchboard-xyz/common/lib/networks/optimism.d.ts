...
export declare const SWITCHBOARD_OPTIMISM_MAINNET_CONFIG: IEvmNetworkConfig;
export declare const SWITCHBOARD_OPTIMISM_TESTNET_CONFIG: IEvmNetworkConfig;
/**
...
```
 */
export declare const SWITCHBOARD_OPTIMISM_CONFIG: IChainConfig;
